...
//         {descriptionHtml ? (
//           <div
//             className="prose prose-lg prose-indigo max-w-none mb-16 prose-headings:font-bold prose-headings:text-gray-900 prose-p:text-gray-700 prose-img:rounded-2xl prose-img:shadow-lg prose-a:text-indigo-600 hover:prose-a:text-indigo-700"
